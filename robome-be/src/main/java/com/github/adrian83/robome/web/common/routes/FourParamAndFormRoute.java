...
public class FourParamAndFormRoute <T> extends AbsFormRoute<T> implements Supplier<Route> {
	  ...
	  public FourParamAndFormRoute(
	      String path, Class<T> clazz, PentaFunction<String, String, String, String, Class<T>, Route> action) {
	    super(path, clazz);
	    this.action = action;
	  }
	  ...
	  public Route get() {
	    ...
	    if (startsWithParameter()) {
	      Function<String, TetraFunction<String, String, String, Class<T>, Route>> newFunc =
	          (String var1) ->
