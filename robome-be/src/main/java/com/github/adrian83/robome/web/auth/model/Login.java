...
@JsonSerialize
public record Login(@JsonProperty(EMAIL_LABEL)
        String email, @JsonProperty(PASSWORD_LABEL)
        String password)
    ...
    private static final ValidationError EMPTY_PASSWORD = new ValidationError(PASSWORD_LABEL, EMPTY_PASSWORD_KEY, EMPTY_PASSWORD_MSG);

    @Override
    public List<ValidationError> validate() {
        return Stream
                .of(check(email, EMPTY_EMAIL, Strings::isNullOrEmpty), check(password, EMPTY_PASSWORD, Strings::isNullOrEmpty))
