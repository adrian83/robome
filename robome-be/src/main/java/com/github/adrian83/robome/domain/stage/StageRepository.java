...
public class StageRepository {
	...
	Function2<StageKey, PreparedStatement, BoundStatement> statementBinder = (key, prepStmt) -> prepStmt
		.bind(key.tableId(), key.stageId(), key.userId());
	...
	Statement<?> stmt = SimpleStatement.newInstance(SELECT_STAGE_BY_ID_STMT, stageKey.tableId(), stageKey.stageId(),
		stageKey.userId());
	...
	var key = new StageKey(row.get(USER_ID_COL, UUID.class), row.get(TABLE_ID_COL, UUID.class),
