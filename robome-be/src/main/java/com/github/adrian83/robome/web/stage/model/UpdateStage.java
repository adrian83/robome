...
@JsonSerialize
public record UpdateStage(@JsonProperty(TITLE_LABEL)
    ...
    private static final ValidationError EMPTY_NAME = new ValidationError(TITLE_LABEL, EMPTY_TITLE_KEY, EMPTY_TITLE_MSG);
