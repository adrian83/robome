...
public class Register {
	...
	@JsonCreator
	public Register(@JsonProperty(EMAIL_LABEL) String email, @JsonProperty(PASSWORD_1_LABEL) String password,
	...
	public String toString() {
		return "Register [email=" + email + ", password=" + hidePassword(password) + ", repeatedPassword="
