...
public class Routes extends AllDirectives {
	...
	private Supplier<Route> prefixVar(String prefix, Function<String, Route> action) {
		Route route = pathPrefix(prefix, () -> pathPrefix(segment(), (var1) -> action.apply(var1)));
		return () -> route;
	}

	public Supplier<Route> prefixVarSlash(String prefix, Function<String, Route> action) {
		Function<String, Route> funcWithSlash = (String var1) -> pathEndOrSingleSlash(() -> action.apply(var1));
	...
	private Supplier<Route> prefixVarPrefix(String prefix1, String prefix2, Function<String, Route> action) {
		Route route = pathPrefix(prefix1, () -> pathPrefix(segment(), (var1) -> pathPrefix(prefix2, () -> action.apply(var1))));
		return () -> route;
	}
	...
	public <T> Supplier<Route> prefixVarFormSlash(String prefix, Class<T> clz, BiFunction<String, Class<T>, Route> action) {
		BiFunction<String, Class<T>, Route> funcWithSlash = (String val, Class<T> clazz) -> pathEndOrSingleSlash(() -> action.apply(val, clazz));
	...
	public <T> Supplier<Route> prefixFormSlash(String prefix, Class<T> clz, Function<Class<T>, Route> action) {
		Function<Class<T>, Route> funcWithSlash = (Class<T> clazz) -> pathEndOrSingleSlash(() -> action.apply(clazz));
	...
	public <T> Supplier<Route> prefixPrefixFormSlash(String prefix1, String prefix2, Class<T> clz, Function<Class<T>, Route> action) {
		Function<Class<T>, Route> funcWithSlash = (Class<T> clazz) -> pathEndOrSingleSlash(() -> action.apply(clazz));
	...
	public Supplier<Route> prefixVarPrefixVar(String prefix1, String prefix2, BiFunction<String, String, Route> action) {
		Function<String, Function<String, Route>> funcWithSlash = (String var1) -> (String var2) -> action.apply(var1, var2);
		Function<String, Route> jj = (String var2) -> prefixVarSlash(prefix2, funcWithSlash.apply(var2)).get();
	...
	// -----
	private <T> Supplier<Route> prefixVarPrefixForm(String prefix1, String prefix2, Class<T> clazz, BiFunction<String, Class<T>, Route> action) {
		Function<String, Function<Class<T>, Route>> func = (String var1) -> (Class<T> clz) -> action.apply(var1, clz);
		Function<String, Route> gg = (String var1) -> prefixForm(prefix2, clazz, func.apply(var1)).get();
	...
	public <T> Supplier<Route> prefixVarPrefixFormSlash(String prefix1, String prefix2, Class<T> clazz, BiFunction<String, Class<T>, Route> action) {
		BiFunction<String, Class<T>, Route> wrapedAction = (String var1, Class<T> clz) -> pathEndOrSingleSlash(() -> action.apply(var1, clz));
