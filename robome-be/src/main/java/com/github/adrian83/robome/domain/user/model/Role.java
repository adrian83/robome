...
public enum Role {
  ...
  private static final List<Role> DEF_USER_ROLES =
      Lists.newArrayList(
          READ_TABLES, WRITE_TABLES, READ_STAGES, WRITE_STAGES, READ_ACTIVITIES, WRITE_ACTIVITIES);

  public static final List<Role> DEFAULT_USER_ROLES =
      Collections.unmodifiableList(Role.DEF_USER_ROLES);
