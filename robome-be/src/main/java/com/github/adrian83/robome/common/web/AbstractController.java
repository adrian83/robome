...
public class AbstractController extends AllDirectives {
  ...
  protected <T> Supplier<Route> prefixForm(
  ...
  protected Supplier<Route> varPrefixVar(String prefix, BiFunction<String, String, Route> action) {
    ...
    Function<String, Function<String, Route>> f =
        (String val1) -> (String val2) -> action.apply(val1, val2);

    Route route = pathPrefix(segment(), val -> prefixVar(prefix, f.apply(val)).get());
    return () -> route;
  }

  protected Supplier<Route> varPrefixVarPrefix(
    ...
    Route route =
        pathPrefix(segment(), val1 -> prefixVarPrefix(prefix1, prefix2, f.apply(val1)).get());
    return () -> route;
  }

  protected <T> Supplier<Route> varPrefixVarPrefixForm(
      String prefix1,
      String prefix2,
      Class<T> clazz,
    ...
    Route route =
        pathPrefix(
            segment(), val1 -> prefixVarPrefixForm(prefix1, prefix2, clazz, f.apply(val1)).get());
    return () -> route;
  }

  protected Supplier<Route> prefixVarPrefixVar(
      String prefix1, String prefix2, BiFunction<String, String, Route> action) {
  ...
  protected Supplier<Route> varPrefixVarPrefixVar(
      String prefix1, String prefix2, TriFunction<String, String, String, Route> action) {

    Function<String, BiFunction<String, String, Route>> f =
        (String val1) -> (String val2, String val3) -> action.apply(val1, val2, val3);

    Route route =
        pathPrefix(segment(), val -> prefixVarPrefixVar(prefix1, prefix2, f.apply(val)).get());
    return () -> route;
  }

  protected Supplier<Route> prefixVarPrefixVarPrefix(
  ...
  protected <T> Supplier<Route> prefixVarPrefixVarPrefixForm(
      String prefix1,
      String prefix2,
      String prefix3,
      Class<T> clazz,
  ...
  protected Supplier<Route> prefixVarPrefixVarPrefixVar(
      String prefix1,
      String prefix2,
      String prefix3,
