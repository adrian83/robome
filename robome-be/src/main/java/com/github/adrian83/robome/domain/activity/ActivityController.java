...
public class ActivityController extends AbstractController {
	...
	private Route getStageActivities(CompletionStage<Optional<User>> maybeUserF, String tableIdStr, String stageIdStr) {
	    ...
	    CompletionStage<HttpResponse> responseF =
	            maybeUserF
	                ...
	                .thenCompose(user -> activityService.getStageActivities(user, StageId.fromStrings(tableIdStr, stageIdStr)))
	...
	private Route getActivityById(CompletionStage<Optional<User>> maybeUserF, String tableIdStr, String stageIdStr, String activityIdStr) {
	    ...
	    CompletionStage<HttpResponse> responseF =
	            maybeUserF
	                ...
	                .thenApply(Authorization::canReadStages)
	                .thenCompose(
	                    user -> activityService.getActivity(user, ActivityId.fromStrings(tableIdStr, stageIdStr, activityIdStr)))
	                ...
	                .thenApply(
	                    activity ->
	                        HttpResponse.create()
	                            ...
	                            .addHeaders(
	                                headers(location(activity.getId()), Cors.origin(corsOrigin()))))
	                .exceptionally(exceptionHandler::handleException);
