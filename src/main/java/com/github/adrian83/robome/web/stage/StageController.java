...
public class StageController extends AllDirectives implements PathParams {
    ...
    private static final String STAGES_PATH = "/api/v1/users/{" + PATH_PARAM_USER_ID + "}/tables/{" + PATH_PARAM_TABLE_ID + "}/stages/";
    private static final String STAGE_PATH = "/api/v1/users/{" + PATH_PARAM_USER_ID + "}/tables/{" + PATH_PARAM_TABLE_ID + "}/stages/{" + PATH_PARAM_STAGE_ID + "}/";
