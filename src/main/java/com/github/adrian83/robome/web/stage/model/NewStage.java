...
@JsonSerialize
public record NewStage(@JsonProperty(TITLE_LABEL) String title) implements Validator {
	...
	return Stream.of(check(title, EMPTY_TITLE, Strings::isNullOrEmpty)).flatMap(Optional::stream)
