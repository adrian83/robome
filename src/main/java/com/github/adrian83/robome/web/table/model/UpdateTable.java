...
@JsonSerialize
public record UpdateTable(@JsonProperty(UpdateTable.TITLE_LABEL) String title,
	@JsonProperty(UpdateTable.DESC_LABEL) String description) implements Validator {
